...
const CACHE_VERSION = 'centralpdf-v1.2.1-pages-10';
...
const CORE_ASSETS = [
  ...
  './assets/css/product-redesign-2.0.css?v=2.0.2',
  ...
  './assets/js/intelligence-0.20.js', './assets/js/app.js', './assets/js/tool-quality-1.2.0.js?v=1.2.3',
