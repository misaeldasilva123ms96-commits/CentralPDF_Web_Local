...
const CACHE_VERSION = 'centralpdf-v1.2.1-pages-17';
const CORE_CACHE = `${CACHE_VERSION}-core`;
const RUNTIME_CACHE = `${CACHE_VERSION}-runtime`;
const CORE_ASSETS = [
  './', './index.html', './assets/css/styles.css', './assets/css/ux-redesign.css',
  './assets/css/layout-controls.css?v=1.2.1-ui1', './assets/css/foundation.css', './assets/css/experience-0.15.css',
  ...
  './assets/css/product-redesign-2.0.css?v=2.0.8',
  ...
  './assets/js/intelligence-0.20.js', './assets/js/app.js?v=1.2.1-ui5', './assets/js/tool-quality-1.2.0.js?v=1.2.3',
