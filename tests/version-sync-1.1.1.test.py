...
for snippet in [
    '2.0.1 estável',
    'Central 2.0.1: qualidade e acessibilidade',
    'Qualidade da versão 2.0.1',
    '<small>Versão</small><strong>${DISPLAY_VERSION}</strong>',
    'Web local ${DISPLAY_VERSION}',
    'v${DISPLAY_VERSION}',
    'Atalhos da versão 2.0.1',
]:
    assert snippet in stable, snippet
assert "qualityLabel.textContent = 'Qualidade 2.0.1';" in head1
assert "qualityLabel.textContent = 'Qualidade 2.0.1';" in head3
assert "const APP_VERSION = '2.0.1';" in foundation
